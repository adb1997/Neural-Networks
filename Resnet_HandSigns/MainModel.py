...
"""Convolutional block. Only difference is that, there is a conv 2d block with batch norm added to 'skip' path that joins after 3 stages right before output ReLu""" 	
